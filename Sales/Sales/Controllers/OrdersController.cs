...
namespace Sales.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        */
        ...
        [HttpGet]
        public async Task<Sales.Models.Orders> GetOrders(int skip = 0, int limit = 10, [FromQuery] string[] embed = null!)
        {
            ...
            var r = Sales.Models.Mapper.Map(orders, embed);

            r.Count = orders.Count();
            r.Total = total;

            return Sales.Hypermedia.Mapper.Append("/api/orders", r, skip, limit, embed, (skip + r.Count) < r.Total);
        }

        [HttpGet("{orderNo}")]
        public async Task<Sales.Models.Order> GetOrderByNo(int orderNo, [FromQuery] string[] embed)
        {
            ...
            return Sales.Models.Mapper.Map(order, embed);
        }
