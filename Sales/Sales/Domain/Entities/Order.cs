...
namespace Sales.Domain.Entities
{
    ...
    public class Order : AuditableEntity, IOrder2WithTotals, IOrder2WithTotalsInternals, ISoftDelete, IHasDomainEvents
    {
        ...
        */
        ...
        public void UpdateOrderStatus(string? orderStatusId)
        {
            ...
            //DomainEvents.Add(new OrderStatusChangedEvent(Id, orderStatusId));
        ...
        public void Clear()
        {
            ...
            DomainEvents.Add(new OrderClearedEvent(OrderNo));
        }
        ...
        public void Delete()
        {
            //DomainEvents.Add(new OrderDeletedEvent(Id));
        }
    ...
    public class OrderStatus : AuditableEntity, /* IHasDomainEvents, */ ISoftDelete
    {
        public OrderStatus()
        {
    ...
    public class OrderItem : AuditableEntity, IOrderItem2, ISoftDelete, IHasDomainEvents
    {
        public Guid Id { get; set; }
