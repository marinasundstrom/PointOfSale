...
{
    public class Subscription : AuditableEntity, IHasDomainEvents, ISoftDelete, ISubscriptionParameters
    {
    ...
    public class SubscriptionPlan : AuditableEntity, IHasDomainEvents, ISoftDelete, ISubscriptionParameters
    {
        public Guid Id { get; set; }
